...
const Project = (props: ProjectType) => {
  return (
    <div className="relative flex flex-col premium:flex-row-reverse gap-[15px]">
      <Image 
        src={ `${props.src}` } 
        alt="Project Image" 
        width={800} 
        ...
        className="w-[400px] h-[220px] md:w-[640px] md:h-[480px] lg:w-[800px] lg:h-[400px] object-cover rounded-lg" />
