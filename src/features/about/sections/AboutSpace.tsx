    ...
    >
      ...
      <div className="space">
        ...
        <Paragraph className="lg:text-slate-400" variant="wide">
          I&apos;ve always been curious about if humans are the only living
          beings in the universe. Eversince I was a child, I have so many
          questions. I wish I could glimpse of what is{" "}
