    ...
    <Section className="grid grid-cols-1 xl:grid-cols-4 premium:grid-cols-5">
      ...
      <div className="xl:order-first xl:col-span-2 programming">
        ...
        <Paragraph variant="wide">
          I&apos;d never had any interest in programming back then, I don&apos;t
          even think myself doing it as a hobby. I remember there was activity
          at my campus where you have to generate and utilize basic HTML. On
          that day, I don&apos;t even know how to begin because I don&apos;t
          even know what to do in the first place. Fortunately, it&apos;s a
          pair, so my friend helped me up. I was watching him at that point
          while he worked on HTML for our activity. I feel as though I am
          falling behind and that I SHOULD be doing these kinds of things. After
          the activity, I began studying the fundamentals of web developing
          about a week later.
          <br />
          <br />I immediately{" "}
