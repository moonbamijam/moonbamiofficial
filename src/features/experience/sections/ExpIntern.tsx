    ...
    <Section className="grid grid-cols-1 xl:grid-cols-4 premium:grid-cols-5">
      ...
      <div className="xl:col-span-2 order-1">
        ...
        <Paragraph variant="wide">
          ...
          friends as well, we&apos;ve learned so many new things especially from
          our seniors. We handled computer assembling and dissambling, cable
          ...
          organization and this can cause you stress. Other than that I&apos;m
          very happy to be part of the department and thank you to the seniors
          who&apos;ve taught us so many things.
        </Paragraph>
      </div>
    </Section>
  );
