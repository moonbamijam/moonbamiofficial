...
const buttonVariants = cva("flex justify-center items-center transform", {
  variants: {
    variant: {
      default:
        "gap-2 rounded-lg border-primary bg-primary text-white hover:bg-primaryvariant capitalize font-semibold",
      outline:
        "gap-2 rounded-lg border-2 border-primary hover:bg-primary hover:text-white capitalize font-semibold",
      ghost:
        "gap-2 rounded-lg bg-[#EBEBEB] dark:bg-dm-surface-light hover:bg-primary dark:hover:bg-primary dark:hover:text-black capitalize font-semibold",
